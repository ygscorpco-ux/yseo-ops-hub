...
export default async function HomePage() {
  ...
  const connectionWatchlist = entries
    .flatMap((entry) =>
      entry.connections
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        eyebrow="채널 상태판"
        title="네이버·구글 현재 상태"
        description="고객별 채널 연결과 현재 상태만 빠르게 확인하는 대시보드입니다."
        actions={
      ...
      <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          {attentionCustomers.length === 0 ? (
            ...
            <div className="space-y-4">
              {attentionCustomers.slice(0, 6).map((entry, index) => (
                <div
        ...
        <SectionCard eyebrow="연결 상태" title="채널 연결 확인">
